...
# Check if ciux is available
if ! command -v ciux &> /dev/null; then
    echo "Error: ciux is not installed or not in PATH"
    echo "Please install ciux v0.0.7+ following the instructions at:"
    echo "https://github.com/k8s-school/ciux/blob/main/README.md#installation"
    exit 1
fi
